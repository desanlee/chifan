	...
	//define fixtures of weed, stone, cannon      
         ...
         fixDef.density = 3.0;	fixDef.friction = 0.1;	fixDef.restitution = 0.2;

	var fixAir = new b2FixtureDef;
        fixAir.density = 0.01;	fixAir.friction = 6.5;	fixAir.restitution = 0.2;		 
		 
	var fixSoap = new b2FixtureDef;
        fixSoap.density = 0.01;	fixSoap.friction = 0.1;	fixSoap.restitution = 0;

        var fixFlesh = new b2FixtureDef;
        fixFlesh.density = 0.1; fixFlesh.friction = 1; fixFlesh.restitution = 0.1;
        
	var fixWood = new b2FixtureDef;
        fixWood.density = 2;	fixWood.friction = 0.1;	fixWood.restitution = 0;
